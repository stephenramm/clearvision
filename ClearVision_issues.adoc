...
| Nothing | Nothing | {tick} | - | - | 
| Nothing | Nothing | - | {tick} | - | 
| Nothing | Nothing | - | - | {tick} | 
| object | same object | - | - | - | Select
| Data object | same data object | {tick} | - | - | Toggle local/global
| Data object | same data object | - | - | {tick} |
| Node object | same data object | {tick} | - | - | Node replication 
| Node object | same data object | - | {tick} | - | Add optional parameter
...
| Nothing | Nothing | {tick} | - | - | Insert non-standard node menu
| Nothing | Nothing | - | {tick} | - | Insert data menu
| Nothing | Nothing | - | - | {tick} | Unassigned
|===
